...
const DitTest = () => {
  ...
  const [showToggleTemplates, toggleTemplatesPanel] = useState(false);

  const containerPictogramsLeft = showPanel ? "red" : "green";
  const containerPictograms = showToggleTemplates ? "red" : "green";

  //   let list = document.querySelectorAll(".diy-icon");
  //   for (let i = 0; i < list.length; i++) {
  //     const element = list[i];
  //     element.onClick = function () {
  //       let j = 0;
  //       while (j < list.length) {
  //         list[j++].className = "diy-icon";
  //       }
  //       list[i].className = "diy-icon active";
  //     };
  //   }
  ...
  return (
    <div className="diy-sidebar">
      <div className="py-2 diy-sidebar-div">
        ...
        <div
          style={{
            backgroundColor: `${containerPictograms}`,
          }}
          onClick={() => toggleTemplatesPanel(!showPanel)}
          className="diy-icon-templates diy-icon active"
        >
          <a href="#">
            <svg
        ...
        <div
          style={{
            backgroundColor: `${containerPictogramsLeft}`,
          }}
          onClick={() => togglePanel(!showPanel)}
          className="diy-icon-pictograms diy-icon"
        >
          <a href="#">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        {/* </li> */}
        {/* <li> */}
        <div className="diy-icon-text diy-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="36.049"
            height="59.77"
        ...
        {/* </li> */}
        {/* <li> */}
        <div className="diy-icon-upload diy-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="48"
            height="55.355"
        ...
        {/* </li> */}
        {/* <li> */}
        <div className="diy-icon-logo diy-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="36.455"
            height="60.355"
        ...
        <div className="diy-icon-background-div">
          <div className="diy-icon-background diy-icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="78"
              height="54"
