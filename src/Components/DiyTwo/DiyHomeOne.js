              ...
              >
                ...
                <a onClick={() => togglePanel(!showPanel)} href="#">
                  ...
                  >
                    ...
                    <g
                      id="Group_211"
                      data-name="Group 211"
                      transform="translate(42.764 366.032)"
                    >
                      <g
                        id="Ellipse_8"
                        data-name="Ellipse 8"
                ...
                <a onClick={() => setTextPanel(!showTextPanel)} href="#">
                  <g
                    id="Group_218"
                    data-name="Group 218"
                    transform="translate(7.475 20.111)"
                  >
                    <text
                      id="Text"
                ...
                <a onClick={() => setUploadPanel(!showUploadPanel)} href="#">
                  <g
                    id="Group_217"
                    data-name="Group 217"
                    transform="translate(7.902 28.111)"
                  >
                    <text
                      id="Upload"
                ...
                <a onClick={() => setLogoPanel(!showLogoPanel)} href="#">
                  <g
                    id="Group_216"
                    data-name="Group 216"
                    transform="translate(5.773 36.525)"
                  >
                    <text
                      id="Logo"
