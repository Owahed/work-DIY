      ...
      <div className="d-flex pt-4">
        ...
        >
          <div style={{ marginLeft: "27%" }}>
            ...
            {showTextPanel && <Text />}
            {showUploadPanel && <Upload handleLogAndImgChange={handleLogAndImgChange} />}
            {showLogoPanel && <Logo handleLogAndImgChange={handleLogAndImgChange} />}
            {showBackgroundPanel && <Background handleLogAndImgChange={handleLogAndImgChange} />}
          </div>
        </div>
        ...
        >
          <div className="diy-body">
            ...
            <img width="80px" src={selectedPictogramsImg.img} alt="" />
            <img width="100px" src={imgState.file} alt="" /> */}
            <div>
              {/* <MainBody selectedPictogramsImg={selectedPictogramsImg}/> */}
              {/* <Test/> */}
              <TestClass/>
            </div>
          </div>
        ...
        <div className="diy-sidebar">
          <div className="py-2 diy-sidebar-div">
            ...
            <div
              ...
              className={"diy-icon-templates " + (showToggleTemplates ? 'diy-icon active' : 'diy-icon')}
            >
            ...
            <div
              ...
              className={"diy-icon-templates " + (showPanel ? 'diy-icon active' : 'diy-icon ')}
            >
              <a href="#">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              ...
              className={"diy-icon-templates " + (showTextPanel ? 'diy-icon active' : 'diy-icon')}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="36.049"
                height="59.77"
            ...
            <div
              ...
              className={"diy-icon-templates " + (showUploadPanel ? 'diy-icon active' : 'diy-icon')}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="48"
                height="55.355"
            ...
            <div
              ...
              className={"diy-icon-templates " + (showLogoPanel ? 'diy-icon active' : 'diy-icon')}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="36.455"
                height="60.355"
            ...
            <div
              ...
              className={"diy-icon-templates " + (showBackgroundPanel ? 'diy-icon active' : 'diy-icon')}>
